...
class DataTransformation:
        ...
        try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ...
                    ('cat_pipeline', cat_pipeline, categorical_columns)  # No change needed here if columns are strings
                ]
            )
            return preprocessor
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            target_feature_test_df = test_df[target_column_name]  # Corrected this line
